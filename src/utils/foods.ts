    ...
    tabs: [
      {
        title: "Hot & Spicy",
        description:
          "Tender delicious juicy protein pieces coated in a hot and spicy glaze. Perfect for those with dietary restrictions, our pieces contain no allergens such as dairy, gluten, soy, and nuts. Our versatile Eat Plant pieces are perfect for a variety of culinary applications including pizza toppings, pies, salad bowls, stir-fry, pasta dishes, curries and more!",
        enquire: "/contact",
        color: "#1ABE71",
      ...
      },
      {
        title: "Smokey BBQ",
        description:
          "Tender delicious juicy protein pieces coated in a smokey BBQ glaze. Perfect for those with dietary restrictions, our pieces contain no allergens such as dairy, gluten, soy, and nuts. Our versatile Eat Plant pieces are perfect for a variety of culinary applications including pizza toppings, pies, salad bowls, stir-fry, pasta dishes, curries and more!",
        enquire: "/contact",
        color: "#1ABE71",
      ...
      },
      {
        title: "Mooin'",
        description:
          "Tender delicious juicy protein pieces. Perfect for those with dietary restrictions, our pieces contain no allergens such as dairy, gluten, soy, and nuts. Our versatile Eat Plant pieces are perfect for a variety of culinary applications including pizza toppings, pies, salad bowls, stir-fry, pasta dishes, curries and more!",
        enquire: "/contact",
        color: "#FFB500",
    ...
    tabs: [
      {
        title: "Breaded",
        description:
          "Eat Plant fillets dusted in a crispy panko crumb, made from a special blend of pea protein and our curious flavours. Perfect to be served in a burger or sliced for a plant-based katsu curry.",
        enquire: "/contact",
        color: "#1ABE71",
      ...
      },
      {
        ...
        description:
          "Eat Plant fillets lightly dusted in a southern fried coating, made from a special blend of pea protein and our curious flavours. Served best on a soft, toasted bun with all your favorite toppings giving a mouth-watering zingy flavour.",
        enquire: "/contact",
        color: "#1ABE71",
        img: "/images/products/fillet/CuriousFillet_Crop.png",
      },
    ...
    tabs: [
      {
        title: "Breaded",
        description:
          "Eat Plant tenders dusted in a crispy panko crumb, made from a special blend of pea protein and our curious flavours. Perfect to be served as a side, in a wrap or a burger.",
        enquire: "/contact",
        color: "#1ABE71",
      ...
      },
      {
        title: "Southern fried original",
        description:
          "Eat Plant tenders dusted in a southern-fried coating, made from a special blend of pea protein and our curious flavours. Perfect to be served as a side, in a wrap or a burger.",
        enquire: "/contact",
        color: "#1ABE71",
        img: "/images/products/tenders/CuriousTenders_Crop.png",
      },
    ...
    tabs: [
      {
        title: "Original",
        description:
          "Our juicy Eat Plant bangers are made from our special pea protein mix, flavoured with sage and parsley. A must have for every fry up and they make a great hotdog and bangers & mash too!",
        enquire: "/contact",
        color: "#F95B77",
      ...
      },
      {
        title: "Jumbo",
        description:
          "Our juicy Eat Plant jumbo bangers are made from our special pea protein mix, flavoured with sage and parsley. A must have for every fry up and they make a great jumbo hotdog and bangers & mash too!",
        enquire: "/contact",
        color: "#F95B77",
    ...
    tabs: [
      {
        title: "Round",
        description:
          "Our Eat Plant patties are tender and juicy, made from our special pea protein mix flavoured with sage and parsley. They make a great breakfast wrap or bap, a perfect way to start the day!",
        enquire: "/contact",
        color: "#F95B77",
  ...
  },
  {
    ...
    tabs: [
      ...
      },
      {
        title: "Cluckin'",
        description:
          "Our Eat Plant chicken flavoured block is tender and juicy, made from our special pea protein mix and lightly seasoned. Can be used to create a variety of curious dishes, our block is what inspires chefs to whip up, throw together, tear, shake, and break the rules – on a mission to redefine plant-based food for a new generation.",
        enquire: "/contact",
        color: "#1ABE71",
    ...
    tabs: [
      {
        title: "Original",
        description:
          "Introducing our signature burger, made from plants and is allergen free! This mouth-watering Eat Plant burger is packed with flavour, a must for your next BBQ. Fancy being creative…simply grill, smash, and serve on a bun with your favorite toppings for an unforgettable smashed burger experience!",
        enquire: "/contact",
        color: "#FFB500",
